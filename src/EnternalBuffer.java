...
public class EnternalBuffer {
    ...
    public static String PlayerTeam="—оратник";
    ...
    System.out.println(CLR.WHITE_BRIGHT+"\n»м€: ["+PlayerName+"]"+CLR.RESET);
    ...
    System.out.println(CLR.RED+"\n—ила:["+PlayerStrength+"] "+CLR.GREEN+"  Ћовкость:["+PlayerAgility+"] "+CLR.BLUE+"  »нтеллект:["+PlayerIntellect+"] "+CLR.BLUE_BRIGHT+" ћаги€:["+PlayerMagic+"] "+CLR.YELLOW+" ’аризма:["+PlayerCharisma+"]");
    System.out.println(CLR.RED_BOLD_BRIGHT+"«доровье:["+PlayerHealth+"/"+PlayerMAXHealth+"] "+CLR.YELLOW_BOLD_BRIGHT+"  ”ровень:["+PlayerLevel+" , "+(PlayerFullLevel%100)+"/100] "+CLR.RESET);
