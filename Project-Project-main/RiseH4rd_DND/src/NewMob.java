...
public class NewMob {
    ...
    public static CharactersMobs Mouse () {
        ...
        Condition.add("Живое");Ability.add("Маленький");
        return CreateNewMob("Mouse",null,"Мышка",Condition,Ability,10,1,5,1,0,2,0,0,true,false);
    }
    public static CharactersMobs Man () {
        ArrayList<String> Condition = new ArrayList<>();
        ArrayList<String> Ability = new ArrayList<>();
        Condition.add("Живое");Ability.add("Человек");
        return CreateNewMob("Man",null,"Мужик",Condition,Ability,4,5,50,6,5,6,0,0,true,true);
    }
}
